namespace aufgabe6 {
	...
	export let data: Auswahl //Heterogen
		...
		"BecherOderWaffel": [
			{ type: "radio", min: 0, max: 0, step: 0, value: 0, name: "Behaelter", id: "Behaelter1", preis: 0, text: "Becher" },
			{ type: "radio", min: 0, max: 0, step: 0, value: 0, name: "Behaelter", id: "Behaelter2", preis: 0, text: "Waffel" }
		],
		"Liefern": [
			{ type: "radio", min: 0, max: 0, step: 0, value: 0, name: "Liefern", id: "Ja", preis: 0, text: "Liefern" },
			{ type: "radio", min: 0, max: 0, step: 0, value: 0, name: "Liefern", id: "Nein", preis: 0, text: "Nicht Liefern" }
		]
	};
