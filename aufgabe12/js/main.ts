namespace aufgabe12 {
    ...
    export let bewegteDingeArray: bewegteDinge[] = [];
    let fps: number = 30;
    ...
    function init(): void {
        ...
        for (let i: number = 0; i < 20; i++) {
            let blub: bewegteDinge = new bewegteDinge(Math.random());
    ...
    function update(): void {
        ...
        for (let i: number = 0; i < bewegteDingeArray.length; i++) {
            bewegteDingeArray[i].update();
        }
    }
